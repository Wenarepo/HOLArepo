...
def classify(im, K, show=False):
    ...
    #imClassesH = np.histogram(imClasses, 10)
    imClassesH= imClasses.tolist()
    imClassesH = imClassesH.histogram(255)
    # Display
    if show:
        ...
        pylab.subplot(224), pylab.plot(imClassesH), pylab.draw(), pylab.pause(0.0001), pylab.title('Histograma Img Segmentada')
        plt.show()
